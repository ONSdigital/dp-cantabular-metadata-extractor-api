...
NB. It will require the JWT Token, including the word 'Bearer', in a Header named Authorization. E.g.

```hp
http://localhost:28300/cantabular-metadata/dataset/RM001/lang/en
```
